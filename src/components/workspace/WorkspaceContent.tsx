...
import SupabaseTableList from './SupabaseTableList'; // Import the new component
      ...
      <Card className="w-full flex flex-col shadow-md rounded-lg">
        ...
        <CardContent className="flex-grow flex flex-col p-4 md:p-6 space-y-6">
          ...
          {parsedData.length > 0 && !isLoadingCsv && (
            <div className="space-y-4 flex-grow flex flex-col min-h-[200px]"> {/* Added min-h for preview */}
          ...
          <Button
            ...
            className="w-full mt-auto" /* Ensure button is at the bottom of its flex container */
          >
            {isUploading ? (
