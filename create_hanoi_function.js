...
async function createHanoiFunction() {
  try {
    console.log('🚀 Bắt đầu tạo function get_simple_monthly_salary_hanoi...');
    ...
    // Test function
    console.log('🧪 Testing function với tháng 7...');
    ...
    if (testError) {
      ...
      console.log('✅ Test thành công! Số rows:', testData?.length || 0);
      console.log('📋 Dữ liệu mẫu:', testData?.slice(0, 3));
    }
