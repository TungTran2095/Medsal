-- Script deploy function get_salary_revenue_ratio_by_location
-- Đã cập nhật:
-- 1. QL/DT được phép = KPI_quy_luong_2025 / Chi_tieu_DT (giống bảng duyệt quỹ lương các tỉnh tháng)
-- 2. Loại bỏ các địa điểm: Medim, Medlatec Group, Med Mê Linh, Medcom, Medon
-- 3. Gộp Med Huế và Med Đà Nẵng thành Med Huda
-- 4. Gộp Med TP.HCM, Med Bình Dương, Med Bình Phước, Med Đồng Nai thành Med Đông Nam Bộ
