-- Script deploy function get_salary_revenue_ratio_by_location (ĐÃ SỬA TẤT CẢ LỖI)
...
-- Bước 2: Tạo function mới với tất cả lỗi đã được sửa
...
-- Bước 4: Test với dữ liệu mẫu (sử dụng cú pháp ARRAY đúng)
SELECT 
    ten_don_vi,
